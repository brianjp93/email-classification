...
def main():
    ...
    # print(h)
    # print(s)
    # ew = ExtractWords("ham", "spam", nummsgfeatures=100, msgfeatures="message.fts")
    ew = ExtractWords("ham", "spam", nummsgfeatures=100)
    print(ew.numham)
    print(ew.numspam)
    ew.countWords(ew.spampaths[:1000], ew.hampaths[:1000])
